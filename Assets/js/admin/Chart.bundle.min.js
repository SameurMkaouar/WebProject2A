                  ...
                  s && l
                    ? (i.retinaScale(r),
                      o.options.responsive &&
                        (i.addResizeListener(l.parentNode, function () {
                          o.resize();
                        }),
                        o.resize(!0)),
                      o.initialize(),
              ...
              i.extend(t.Controller.prototype, {
                ...
                resize: function (e) {
                  ...
                  if (
                    ...
                    t.plugins.notify(n, "resize", [d]),
                      n.options.onResize && n.options.onResize(n, d),
                      n.stop(),
                ...
                update: function (e, a) {
                  var r = this;
                  n(r),
                    t.plugins.notify(r, "beforeUpdate"),
                  ...
                  i.each(
                    ...
                    t.layoutService.update(r, r.chart.width, r.chart.height),
                    t.plugins.notify(r, "afterScaleUpdate"),
                    i.each(o, function (t) {
                      t.reset();
                    }),
                    r.updateDatasets(),
                    t.plugins.notify(r, "afterUpdate"),
                    r._bufferedRender
                      ? (r._bufferedRequest = { lazy: a, duration: e })
                      : r.render(e, a);
                },
                ...
                render: function (e, n) {
                  ...
                  if (
                    ...
                    (o.numSteps = (e || r.duration) / 16.66),
                      ...
                      t.animationService.addAnimation(a, o, e, n);
                  } else
                    a.draw(),
                      r &&
                        r.onComplete &&
                ...
                draw: function (e) {
                  var n = this,
                    a = e || 1;
                  n.clear(),
                    t.plugins.notify(n, "beforeDraw", [a]),
                    i.each(
                      n.boxes,
                      function (t) {
                        t.draw(n.chartArea);
                    ...
                    t.plugins.notify(n, "beforeDatasetsDraw", [a]),
                    i.each(
                      n.data.datasets,
                      function (t, i) {
                        n.isDatasetVisible(i) &&
                          n.getDatasetMeta(i).controller.draw(e);
                      },
                      n,
                      !0
                    ),
                    t.plugins.notify(n, "afterDatasetsDraw", [a]),
                    n.tooltip.transition(a).draw(),
                    t.plugins.notify(n, "afterDraw", [a]);
                },
                ...
                destroy: function () {
                  var e,
                    ...
                    r = this,
                    o = r.chart.canvas;
                  for (r.stop(), n = 0, a = r.data.datasets.length; n < a; ++n)
                    (e = r.getDatasetMeta(n)),
                      e.controller &&
                        (e.controller.destroy(), (e.controller = null));
                  o &&
                    (i.unbindEvents(r, r.events),
                    i.removeResizeListener(o.parentNode),
                    i.clear(r.chart),
                    t.platform.releaseContext(r.chart.ctx),
                    (r.chart.canvas = null),
                    (r.chart.ctx = null)),
                    t.plugins.notify(r, "destroy"),
                ...
                eventHandler: function (e) {
                  ...
                  var r = t.platform.createEvent(e, n.chart),
                    o = n.handleEvent(r);
                  (o |= i && i.handleEvent(r)),
                    (o |= t.plugins.notify(n, "onEvent", [r]));
                  var s = n._bufferedRequest;
                  return (
                    s
                      ? n.render(s.duration, s.lazy)
                      : o &&
                        !n.animating &&
                        (n.stop(), n.render(a.animationDuration, !0)),
                    (n._bufferedRender = !1),
          ...
          e.exports = function (t) {
            ...
            (r.requestAnimFrame = (function () {
              ...
              (r.addResizeListener = function (t, e) {
                ...
                (n.className = "chartjs-hidden-iframe"),
                  (n.style.cssText =
                  ...
                  (n.tabIndex = -1);
                var i = (t._chartjs = { resizer: n, ticking: !1 }),
                  a = function () {
                    i.ticking ||
                      ((i.ticking = !0),
              ...
              update: function (t, n, i) {
                ...
                function o(t) {
                  var n = e.findNextWhere(C, function (e) {
                    ...
                    i = { left: 0, right: 0, top: R, bottom: V };
                    ...
                    if (c.drawBorder) {
                      ...
                      m
                        ? ((W = Y = "top" === r.position ? a.bottom : a.top),
                          (W += B),
                          (Y += B))
                        : ((V = L = "left" === r.position ? a.right : a.left),
                          (V += B),
                          (L += B)),
                        l.beginPath(),
                        l.moveTo(V, W),
