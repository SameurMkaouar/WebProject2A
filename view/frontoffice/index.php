			...
			<section class="intro_section page_mainslider ds">
				<div class="flexslider">
					<ul class="slides">
						...
						<li>
							<img src="../../Assets/FrontOffice/images/slide01.jpg" alt="">
							<div class="container">
								<div class="row">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-push-6 text-center">
							...
							<img src="../../Assets/FrontOffice/images/signature.png" alt="" />
						</div>
						<div class="col-md-6 col-md-pull-6 text-center bottommargin_0">
							<img src="../../Assets/FrontOffice/images/person.png" alt="" class="top-overlap" />
						</div>
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-md-4 text-center">
							<article class="vertical-item content-padding post format-standard with_shadow">
								...
								<div class="item-media entry-thumbnail">
									<img src="../../Assets/FrontOffice/images/blog_post1.jpg" alt="">
								</div>
								...
								<div class="item-content entry-content">
									<header class="entry-header">
										...
										<h4 class="entry-title">
											<a href="blog-single-right.php" rel="bookmark">How to avoid hostile attitude</a>
										</h4>
									...
									<a href="blog-single-right.php" class="theme_button color1">Read article</a>
						...
						<div class="col-md-4 text-center">
							<article class="vertical-item content-padding post format-standard with_shadow">
								...
								<div class="item-media entry-thumbnail">
									<img src="../../Assets/FrontOffice/images/blog_post2.jpg" alt="">
								</div>
						...
						<div class="col-md-4 text-center">
							<article class="vertical-item content-padding post format-standard with_shadow">
								...
								<div class="item-media entry-thumbnail">
									<img src="../../Assets/FrontOffice/images/blog_post3.jpg" alt="">
								</div>
						...
						<div class="col-md-6">
							...
							<div class="tab-content padding_0">
								...
								<div class="tab-pane fade in active" id="tab1">
									<div class="embed-responsive embed-responsive-16by9">
										<a href="//player.vimeo.com/video/1084537" class="embed-placeholder">
											<img src="../../Assets/FrontOffice/images/video_tab1.jpg" alt="">
										</a>
									</div>
								</div>
								...
								<div class="tab-pane fade" id="tab2">
									<div class="embed-responsive embed-responsive-16by9">
										<a href="//player.vimeo.com/video/1084537" class="embed-placeholder">
											<img src="../../Assets/FrontOffice/images/video_tab2.jpg" alt="">
										</a>
									</div>
								</div>
								...
								<div class="tab-pane fade" id="tab3">
									<div class="embed-responsive embed-responsive-16by9">
										<a href="//player.vimeo.com/video/1084537" class="embed-placeholder">
											<img src="../../Assets/FrontOffice/images/video_tab3.jpg" alt="">
										</a>
									</div>
								</div>
							</div>
