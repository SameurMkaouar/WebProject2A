...
if (!empty($userInfo)) {
	...
	$userStatus=isset($userRecord['Status']) ? $userRecord['Status'] : "";
...
//FETCH POSTS
$Post = new Post();
$posts = $Post->getMyRecentPosts($_SESSION['user_id']);

$Comment = new Comment();
$comments = $Comment->getUserPostComments($_SESSION['user_id']);

$commentCount = $Comment->getUserCommentCount($_SESSION['user_id']);
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="stts <?php echo ($userStatus === 'pending') ? 'pending' : 'approved'; ?>">
                        <p>profile status: <?php if($userStatus==="pending"){?><i
                                class="rt-icon2-eye2"></i><?php } else{ ?><i class="rt-icon2-checkmark"></i><?php }?>
                        </p>
                    </div>
                </div>
                                    ...
                                    <div class="media big-left-media">
                                        ...
                                        <div class="media-body">
                                            <h4><?php echo $firstname.' '.$lastname;?>
                                                ...
                                                <a href="profile_edit.php" profil.html value="Send Message"><i
                            ...
                            <div class="col-xs-12 col-md-6">
                                ...
                                <div class="with_border with_padding">
                                    ...
                                    <div class="admin-scroll-panel scrollbar-macosx">
                                        <ul class="list1 no-bullets" id="comments">
                                            ...
                                            <li class="item-editable">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <h5>
                                                            <strong> <?php echo $firstname.' '.$lastname;?> on <a
                                                                    style="    color: #91d0cc;"
                                                                    href="blog-single-full.php?id=<?php echo $comment['id_post']; ?>"><?php echo $comment['post_title']; ?></a></strong>
                                                            <small><?php echo getTimeDiff($comment['comment_time']); ?></small>
                                                        </h5>
                                                        <div class="content-container">
                                                            <?php echo $comment['comment_content']; ?>
                                                            <a href="../../controller/deleteComment.php?id=<?php echo $comment['id_comment']; ?>"
                                                                id="delete"><i class="rt-icon2-trashcan"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <li class="item-editable">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <div>
                                                            <a
                                                                href="blog-single-full.php?id=<?php echo $post['id_post']; ?>"><?php echo $post['post_title']; ?></a>
                                                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="panel-group bottommargin_0" id="contact-info-accordion">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="icon-tab" data-toggle="collapse"
                                                    data-parent="#contact-info-accordion" href="#user-info-collapse1">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="icon-tab collapsed" data-toggle="collapse"
                                                    data-parent="#contact-info-accordion" href="#user-info-collapse2">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="icon-tab collapsed" data-toggle="collapse"
                                                    data-parent="#contact-info-accordion" href="#user-info-collapse3">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="icon-tab collapsed" data-toggle="collapse"
                                                    data-parent="#contact-info-accordion" href="#user-info-collapse4">
                                ...
                                <div class="with_border with_padding">
                                    ...
                                    <form method="post" action="./">
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group has-placeholder">
                                                        ...
                                                        <input class="form-control" type="text" name="name"
                                                            placeholder="Name" value="" id="form-id-1"
                                                            required="required">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group has-placeholder">
                                                        ...
                                                        <input class="form-control" type="text" name="phone"
                                                            placeholder="Phone" value="" id="form-id-2"
                                                            required="required">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group has-placeholder">
                                                        ...
                                                        <input class="form-control" type="text" name="email"
                                                            placeholder="Email" value="" id="form-id-3"
                                                            required="required">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group has-placeholder">
                                                        ...
                                                        <textarea class="form-control" name="message"
                                                            placeholder="Message" id="form-id-4"
                                        ...
                                        <div class="wrap-forms">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input class="theme_button wide_button color1" type="submit"
                                                        value="Send Message">
