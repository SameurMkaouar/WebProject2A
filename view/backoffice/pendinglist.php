...
foreach( $result as $row)
{
    ?> 
                  <tr class="item-editable">
                    <td class="media-middle text-center">
                    <a href="../../controller/acceptpending.php?id=<?php echo $row["Id"];?>">accept</a>
                    </td>
                    <td class="media-middle text-center">
                    <a href="../../controller/deleteuser.php?id=<?php echo $row["Id"];?>">deny</a>
                    </td>
                    <td>
                      <div class="media">
                        <div class="media-left">
                        <?php echo '<a href="test.php"><img src="data:image/jpeg;base64,' . base64_encode($row["Picture"]) .'" alt="User Image"></a>'; ?>                        </div>
