...
<body>
    <?php foreach ($list as $l) { ?>
        <form method="POST">
            <div class="card">
                <img src="data:image/jpeg;base64,<?php echo base64_encode($l["image"]); ?>" alt="Event Image">
                <div class="card__content">
                    <p class="card__title">ID Event : <?php echo $l["idevent"]; ?></p>
                    <p class="card__description">Date : <?php echo $l["dateevent"]; ?></p>
					<p class="card__description">ID Réservation : <?php echo $l["idreservation"]; ?></p>
					<p class="card__description">Nombre Place : <?php echo $l["nbplace"]; ?></p>
					<p class="card__description">Mode de paiement : <?php echo $l["paiement"]; ?></p>
                </div>
            </div>
        </form>
    <?php } ?>
