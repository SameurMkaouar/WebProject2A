  ...
  <body class="admin">
    ...
    <div id="canvas">
      <div id="box_wrapper">
        ...
        <header
          class="page_header_side page_header_side_sticked active-slide-side-header ds"
        >
                    ...
                    <a href="#">
                      <div class="media">
                        <div class="media-left media-middle">
                          <img
                            src="../../assets/frontoffice/images/team/01.jpg"
                            alt=""
                          />
                        </div>
              ...
              <nav class="mainmenu_side_wrapper">
                ...
                <ul class="menu-click">
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        <a href="admin_posts.html"> Posts </a>
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="admin_order.html"> Single Order </a>
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        <a href="admin_comments.html"> Comments </a>
                      </li>
                      <li>
                        <a href="admin_comment.html"> Single Comment </a>
                      </li>
                    </ul>
                  </li>
                  <li>
        ...
        <header class="page_header header_darkgrey">
          <div class="widget widget_search">
            <form method="get" class="searchform form-inline" action="/">
              <div class="form-group">
                <label class="screen-reader-text" for="widget-search-header"
                  >Search for:</label
                >
                <input
                  id="widget-search-header"
                  type="text"
                  value=""
                  name="search"
                  class="form-control"
                  ...
                  <ul class="list1 no-bullets no-top-border no-bottom-border">
                    ...
                    <li>
                      <div class="media">
                        <div class="media-left">
                          <img
                            src="../../assets/frontoffice/images/team/02.jpg"
                            alt="..."
                          />
                        </div>
                        <div class="media-body">
                    ...
                    <li>
                      <div class="media">
                        <div class="media-left">
                          <img
                            src="../../assets/frontoffice/images/team/03.jpg"
                            alt="..."
                          />
                        </div>
                        <div class="media-body">
            ...
            <div class="row">
              <div class="col-md-6">
                <ol class="breadcrumb darklinks">
                  ...
                  <li class="active">Full post view</li>
                </ol>
              </div>
              <!-- .col-* -->
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="with_border with_padding">
                  ...
                  <div class="row form-group" id="post-detail"></div>

                  <div class="row">
                    <div class="col-sm-12 text-right">
                    <form action="../../controller/approvePost.php" method="GET" id="approve-post">
                      <?php if($post['post_status']==="Pending"){?>
                        <button class="theme_button wide_button">
                          Approve post<i class="rt-icon2-checkmark2"></i>
                        </button>
                        <?php }?>
                      </form>
                      <?php if($post['post_status']==="Pending"){?>
                        <a href="../../controller/deletePost.php?id=<?php echo $post_id; ?>">
                      <button class="theme_button wide_button">
                        Reject post<i class="rt-icon2-cancel2"></i>
                      </button></a>
                      <?php }?>
                    </div>
                  </div>
                  ...
                  <ul class="list1 no-bullets">
                    ...
                    <li>
                      <div class="media small-teaser">
                        ...
                        <div class="media-body media-middle">
                          <strong class="grey"> Posts: </strong>
                          146
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div class="media small-teaser">
                        ...
                        <div class="media-body media-middle">
                          <strong class="grey"> Orders: </strong>
                          12
                        </div>
                      </div>
                    </li>
    ...
    <script src="../../assets/ressources/showPostAdmin.js"></script>
    <script src="../../assets/ressources/validerForm.js"></script>
  </body>
</html>
